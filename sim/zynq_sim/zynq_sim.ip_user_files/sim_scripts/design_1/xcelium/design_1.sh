...
# Design libraries
design_libs=(simprims_ver xpm xil_defaultlib axi_bram_ctrl_v4_1_7 lib_cdc_v1_0_2 proc_sys_reset_v5_0_13)
...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../zynq_sim.gen/sources_1/bd/design_1/ipshared/7698" \
       +incdir+"../../../../zynq_sim.gen/sources_1/bd/design_1/ipshared/7698" \
       -input simulate.do
}
