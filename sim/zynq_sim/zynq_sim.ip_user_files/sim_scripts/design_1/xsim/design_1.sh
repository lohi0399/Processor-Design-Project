...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L xil_defaultlib -L axi_bram_ctrl_v4_1_7 -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}
